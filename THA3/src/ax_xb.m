function [X] = ax_xb(q_Robot_config, q_camera_config,t_Robot_config,t_camera_config )
%  ax_xb calculates the missing Rx and qx 
%  (rotation and translation between the camera and robot manipulator)
%   using the quaternion approach 
%  
%
% Use:
...
% - t_Robot_config is a nx4 matrix of different robot translation for Ei
% - t_camera_config is a nx4 matrix of different sensor translation for Si
%
%   
% Outputs:
%  X = A number 3X3 rotation matricies depending on the number of sensor and
%  and robot configurations and the last column is 3X1 vector representing
